...
public class SearchBeanDao extends AbstractDao<SearchBean, String> {
    ...
    public List<SearchBean> loadAll() {
    }
    ...
    public static class Properties {
        public final static Property Kerword = new Property(0, String.class, "kerword", true, "KERWORD");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SEARCH_BEAN\" (" + //
                "\"KERWORD\" TEXT PRIMARY KEY NOT NULL ," + // 0: kerword
                "\"TIME\" INTEGER);"); // 1: time
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, SearchBean entity) {
        ...
        String kerword = entity.getKerword();
        if (kerword != null) {
            stmt.bindString(1, kerword);
        }
    ...
    public SearchBean readEntity(Cursor cursor, int offset) {
        SearchBean entity = new SearchBean( //
            cursor.isNull(offset + 0) ? null : cursor.getString(offset + 0), // kerword
    ...
    public void readEntity(Cursor cursor, SearchBean entity, int offset) {
        entity.setKerword(cursor.isNull(offset + 0) ? null : cursor.getString(offset + 0));
